...
void User::getBrugerInfo(string& cprNumber, string& firstName, string& lastName) {
    Person::getName(firstName, lastName);
    Person::getCPR(cprNumber);
}

void User::setBrugerInfo(string cprNumber, string firstName, string lastName) {
    Person::setCPR(cprNumber);
